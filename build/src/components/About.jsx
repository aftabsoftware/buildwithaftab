export default function About() {
    ...
    const data = [
        {
            ...
            description: 'HTML, CSS, JavaScript, PHP, React Js, Next Js',
        },
        {
            name: 'Education',
        ...
        },
        {
            ...
            description: 'Built more than 25 projects',
        },
    ];
    return (
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/about-img-2.png' alt="" className="w-64 sm:w-80 rounded-3xl max-w-none" />
  ...
  I am a Full-Stack Developer based in India with strong expertise in WordPress, WooCommerce, and custom web development. I build scalable, secure, and performance-optimized websites, develop custom themes and plugins, and create modern applications using React and Next.js. My focus is on clean code, SEO optimization, and delivering business-oriented digital solutions.
</p>
