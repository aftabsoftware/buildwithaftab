export default function Work() {
    const work = [
  {
    ...
    description: 'React, Next.js, PHP, WooCommerce',
    link: '',
  },
  {
    name: 'Real-time Chat Application',
    icon: './assets/work-2.png',
    description: 'React.js, Socket.IO, Node.js',
    link: '',
  },
  {
    name: 'Custom WordPress Platform',
    icon: './assets/work-3.png',
    description: 'WordPress, PHP, Custom Plugins',
    link: '',
  },
  {
    name: 'Business Portfolio Website',
    icon: './assets/work-4.png',
    description: 'Next.js, Responsive Design',
    link: '',
  }
];
    return (
